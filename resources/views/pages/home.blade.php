        ...
        <div class="container h-100">
            <div class="row d-flex flex-row align-items-center h-100">
                <div class="col-12 col-md-6 mt-4 mt-md-0">
                    ...
                    <p class="font-weight-bold mt-3">🚀 {{__("Start monetizing your content today!")}}</p>
                    <div class="mt-4">
                        <a href="{{route('register')}}" class="btn btn-grow bg-gradient-primary  btn-round mb-0 me-1 mt-2 mt-md-0 ">{{__('Register')}}</a>
                ...
                <div class="col-12 col-md-4 mb-5 mb-md-0">
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <div class="col-12 col-md-10 text-center">
                            ...
                            <span>{{__("You have full control over your content.")}}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="my-5 py-5 home-bg-section">
        <div class="container">
            <div class="text-center mb-4">
                ...
                <p>{{__("Here's list of curated content creators to start exploring now!")}}</p>
            </div>
